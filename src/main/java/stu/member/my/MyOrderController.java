...
Logger log = Logger.getLogger(this.getClass());
	...
	// 마이페이지 - 주문리스트  /myOrderList.do -> /my/myOrderList.do 수정
	@RequestMapping(value="/my/myOrderList.do")
	...
	// 마이페이지 - 교환.환불.as 리스트 ///myAsList.do -> /my/myAsList.do
	@RequestMapping(value="/my/myAsList.do")
