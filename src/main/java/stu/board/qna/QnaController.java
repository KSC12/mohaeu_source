...
public class QnaController {
	...
	@RequestMapping(value="/qna/openAdminQnaList.do")
    public ModelAndView openAdminQnaList(CommandMap commandMap) throws Exception{
    	ModelAndView mv = new ModelAndView("/board/adminQnaList");
	...
	public ModelAndView openQnaDetailPost(CommandMap commandMap) throws Exception{
	...
	@RequestMapping(value="/qna/openQnaDetail.do", method = RequestMethod.GET)
	public ModelAndView openQnaDetailGet(CommandMap commandMap) throws Exception{
	    ModelAndView mv = new ModelAndView("/board/qnaDetail");
	...
	@RequestMapping(value="/qna/openQnaUpdate.do", method = RequestMethod.POST)
