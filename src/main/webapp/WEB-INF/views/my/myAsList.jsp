	...
	<div class="contents">
		...
		<div class="article" align="center">
			...
			<table align="center" width="100%" id="conlist">
				...
				<thead>
					<tr>
						<th style="text-align:center" scope="col">오늘</th>
						<th style="text-align:center" scope="col">일주일</th>
						<th style="text-align:center" scope="col">1개월</th>
						<th style="text-align:center" scope="col">3개월</th>
						<th style="text-align:center" scope="col">6개월</th>
					</tr>
				</thead>
				<tbody>
					<tr>	
		...
		<div class="table-responsive">
			<table class="table table-striped">
				...
				<thead>
					<tr>
						<th style="text-align:center" scope="col">신청날짜<br />신청번호</th>
						<th style="text-align:center" scope="col">요청사항</th>
						<th style="text-align:center" scope="col">처리현황</th>
					</tr>
				</thead>
