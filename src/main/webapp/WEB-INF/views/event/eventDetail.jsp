...
.eventDetail_bottomDiv {margin: 100px 0 100px 0; border: 1px solid darkgray; width: 800px; padding: 50px 0 50px 50px; border-radius: 30px;}
.container, eventDetail_bottomDiv {position:relative;}
</style>
