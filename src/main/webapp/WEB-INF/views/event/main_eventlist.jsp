	...
	if(total == 0){
		...
		$.each(data.list, function(key, value){
			str += "<tr>"
					...
					+ 	"<a href='#this' name='eventClick'><img alt='image' width='500px' style='margin: 20px 0 0 0; border: 1px solid #DCDCDC; border-radius: 10px;' src='/file/" + value.EVENT_THUMBNAIL + "'></a>"
