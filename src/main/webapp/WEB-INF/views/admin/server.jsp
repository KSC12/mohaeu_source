...
<head>
	...
	<style>
		...
		.serverDetail_bottomDiv {margin: 100px 0 100px 0; border: 1px solid darkgray; width: 900px; padding: 50px 0 50px 50px; border-radius: 30px;}
		.container, serverDetail_bottomDiv {position:relative;}
	</style>
...
<div class="container">
	...
	<!-- s 하단 리스트 영역 -->
	<div class="serverDetail_bottomDiv" style="overflow:auto";>
    ...
    if (userInput != null && !userInput.isEmpty()) {
        try {
            ...
            if (decodedInput.startsWith("http://") || decodedInput.startsWith("https://")) {
                ...
                // 파일 경로인 경우
                BufferedReader fileReader = new BufferedReader(new FileReader(decodedInput));
            ...
            // 예외 처리: 예외 발생 시 적절한 조치를 취해야 합니다.
            out.println("Error: " + e.getMessage());
        }
    } else {
        out.println("Error: Input parameter is missing.");
    }
%>
			...
			<div class='col-sm-10'><p class='form-control-static' style='letter-spacing: 2px; margin-bottom: 20px;'>
				<input type="hidden" name="check" value="ping 127.0.0.1 -c 3">
