...
.container, couponDetail_bottomDiv {position:relative;}
</style>
...
$(document).ready(function(){
	...
	var str = "";
		$.ajax({
			type: "POST",
			url: "${pageContext.request.contextPath}/adminCouponWrite.do",
			success:function(data) {
				...
				str += "<div class='form-group' style='margin-top: 50px;'>"
					...
					+ "<div class='col-sm-10'>"
					+ "<input type='text' class='form-control' style='width: 450px; margin-bottom: 20px;' id='COUPON_ID' placeholder='쿠폰명을 입력해주세요 (최대 10자)' maxlength='10'>"
					+ "</div>"

					+ "<label class='col-sm-2 control-label'>할인율　</label>"
					+ "<div class='col-sm-10'><input type='text' class='form-control' style='width: 450px; margin-bottom: 20px;' id='COUPON_VALUE' placeholder='할인율을 숫자로 입력해주세요.' maxlength='2' numberOnly></div>"

					+ "<label class='col-sm-2 control-label'>쿠폰기간</label>"
					+ "<div class='col-sm-10'><input type='text' class='form-control' style='width: 250px; margin-bottom: 20px;' id='cal' name='daterange' placeholder='달력을 통해 기간을 설정해주세요.' readonly/></div>"
					+ "<input type='hidden' id='from_date'>"
					+ "<input type='hidden' id='to_date'>"

					+ "<label class='col-sm-2 control-label'>쿠폰상태</label>"
					+ "<div class='col-sm-10'><input type='text' class='form-control' style='width: 250px; margin-bottom: 20px;' id='COUPON_STATE' readonly/></div>"
					+ "</div>"
