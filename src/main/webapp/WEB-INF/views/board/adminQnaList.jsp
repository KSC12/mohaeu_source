   ...
   <div class="pagemid">
      <div class="wrapper3">
         <ul class="flex-menu">
            ...
            <li><a href="/qna/openAdminQnaList.do">QNA</a></li>
         </ul>
         <br>
         <div class="bar"></div>
      </div>
      ...
      function fn_selectQnaListCallback(data) {
         ...
         if (total == 0) {
            ...
            $("a[name='title']").on("click", function(e){ //제목
            	...
            	var selectListClass = $(this).parent().parent()[0];
            	var rnum = selectListClass.children[0].textContent;			// 글번호
            	var qnaNo = selectListClass.children[1].children[1].value;	// 글제목에 해당하는 value
